...
import { Upload, Filter, Search, MoreHorizontal, Check, AlertCircle, ShoppingBag, ArrowUpRight, Play, RotateCw, History, X } from 'lucide-react';
...
export default function Products() {
    ...
    const handleUpload = async (e) => {
        ...
        formData.append('brand_id', currentBrand.id);
        ...
        try {
            ...
            if (res.ok && data.success) {
                toast.success(`Uploaded ${data.products_count} products!`, { id: toastId });
                loadProducts(1);
            } else {
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <label className={`btn bg-primary text-primary-foreground px-4 py-2 rounded-lg shadow-lg hover:shadow-xl hover:bg-primary/90 cursor-pointer flex items-center gap-2 transition-all ${uploading ? 'opacity-70 pointer-events-none' : ''}`}>
                        <Upload size={18} />
                            ...
                            products.map(product => (
                                ...
                                >
                                    ...
                                    <td className="p-4 align-middle text-right" onClick={(e) => e.stopPropagation()}>
                                        <Link to={`/${currentBrand.code}/products/${product.product_id}`} target="_blank">
